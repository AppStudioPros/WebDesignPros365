...
export default function PricingPageClient() {
  return (
    <>
      <section className="bg-[#252640] text-[#f0eef8] py-24 px-4 sm:px-6 lg:px-8 pt-32">

        {/* Header */}
        <div className="max-w-4xl mx-auto text-center mb-16">
          <Badge className="mb-4 bg-[#1e1c35] text-[#8734E1] border-[#8734E1]">Pricing</Badge>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="mt-2 text-4xl font-extrabold sm:text-5xl text-[#f0eef8]"
          >
          ...
          <motion.p
            ...
            className="mt-4 text-xl text-[#8a87a8] max-w-2xl mx-auto"
          >
        ...
        <div className="max-w-7xl mx-auto grid gap-8 lg:grid-cols-3 items-start mb-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="border border-[#3a3858] bg-[#1c1d30] rounded-2xl p-8 flex flex-col justify-between h-full hover:shadow-lg transition-shadow"
          >
            <div>
              <h3 className="text-xl font-bold text-[#f0eef8]">Launch</h3>
              <p className="mt-2 text-sm text-[#8a87a8]">Perfect for small businesses and startups launching their professional web footprint.</p>
              <div className="mt-6">
                <p className="flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold tracking-tight text-[#f0eef8]">$3,750</span>
              ...
              <ul className="mt-6 space-y-3 text-sm text-[#a8a4c8] border-t border-[#3a3858] pt-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="border-2 border-[#8734E1] bg-[#252640] rounded-2xl p-8 flex flex-col justify-between h-full relative shadow-xl shadow-[#8734E1]/10"
          >
            ...
            <div>
              <h3 className="text-xl font-bold text-[#f0eef8]">Growth</h3>
              <p className="mt-2 text-sm text-[#8a87a8]">For growing brands that require custom design structures and deep content engines.</p>
              <div className="mt-6">
                <p className="flex items-baseline gap-1">
          ...
          >
            <div>
              <h3 className="text-xl font-bold text-[#f0eef8]">Pro</h3>
              <p className="mt-2 text-sm text-[#8a87a8]">Corporate properties needing complex AI interfaces and rigid accessibility features.</p>
              <div className="mt-6">
                <p className="flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold tracking-tight text-[#f0eef8]">$15,000</span>
                  <span className="text-sm font-semibold text-gray-400">to start</span>
                </p>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="max-w-7xl mx-auto border border-[#3a3858] bg-[#1c1d30] rounded-3xl p-8 lg:p-12"
        >
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="pb-8 lg:pb-0">
              ...
              <h4 className="text-2xl font-bold mt-1 text-[#f0eef8]">Custom Package</h4>
              <div className="mt-4">
                <p className="flex items-baseline gap-1">
                  <span className="text-3xl font-extrabold text-[#f0eef8]">$25,000+</span>
                  <span className="text-sm font-semibold text-gray-400">to start</span>
                </p>
                <p className="text-xs text-gray-400 mt-1">$50,000+ total · 50/25/25 milestone payments</p>
              </div>
              <p className="text-sm text-[#8a87a8] mt-2">Multi-language, headless commerce, and deep legacy software system hooks.</p>
              <ul className="mt-6 space-y-2 text-sm text-[#a8a4c8]">
            ...
            <div className="pt-8 lg:pt-0 lg:pl-12">
              ...
              <h4 className="text-2xl font-bold mt-1 text-[#f0eef8]">Flagship ACI-Powered</h4>
              <div className="mt-4">
                <p className="flex items-baseline gap-1">
              ...
              <p className="text-sm text-[#8a87a8] mt-2">Full 5-layer Adaptive Compound Intelligence engineering with audit trails.</p>
              <ul className="mt-6 space-y-2 text-sm text-[#a8a4c8]">
