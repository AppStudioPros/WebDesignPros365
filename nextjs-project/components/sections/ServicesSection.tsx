...
import { ArrowRight, Sparkles, Brain, Gauge, Code, Database, TrendingUp, Share2, ShoppingCart, Server, Layers, Palette } from 'lucide-react'
import { Card, CardContent, Badge, Button } from '@/components/ui'

// Services data (would come from Sanity in production)
const services = [
  {
