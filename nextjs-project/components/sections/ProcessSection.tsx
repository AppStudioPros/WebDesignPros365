...
const steps = [
  ...
  },
  {
    number: '03',
    title: 'Design',
    description: 'Create stunning UI/UX designs that align with your brand identity.',
    icon: Palette,
  },
  {
    number: '04',
    title: 'Development',
    description: 'Build with modern tech: Next.js, TypeScript, and best practices.',
    icon: Code,
  },
  {
    number: '05',
  ...
  },
  {
    number: '06',
    title: 'Launch',
    description: 'Deploy to Vercel with optimized caching, monitoring, and support.',
    icon: Rocket,
  },
]
