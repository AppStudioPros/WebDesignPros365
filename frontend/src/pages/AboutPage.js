...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="py-12 bg-[#1a1f2e] border-y border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="glass p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3"><span className="text-2xl">2</span><div><p className="font-medium text-white">Senior Developers</p><p className="text-sm text-white/60">No juniors, no handoffs - direct access to experts</p></div></li>
                <li className="flex items-start gap-3"><span className="text-2xl">🎯</span><div><p className="font-medium text-white">Innovative Practices</p><p className="text-sm text-white/60">GEO, AI integration, and cutting-edge tech</p></div></li>
                <li className="flex items-start gap-3"><span className="text-2xl">🛠️</span><div><p className="font-medium text-white">Tailored Solutions</p><p className="text-sm text-white/60">Every project is unique - no templates</p></div></li>
                <li className="flex items-start gap-3"><span className="text-2xl">✅</span><div><p className="font-medium text-white">Rigorous Testing</p><p className="text-sm text-white/60">Every project is thoroughly QA'd before launch</p></div></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            {team.map((member) => (
              <Card key={member.name} className="p-6 hover:bg-white/10 transition-colors">
                <div className="flex items-start gap-4">
                  <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-[#00d9ff] to-[#0066cc] flex items-center justify-center text-white text-2xl font-bold flex-shrink-0">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      {member.socialLinks.map((social) => (
                        <a key={social.platform} href={social.url} className="p-2 text-white/40 hover:text-[#00d9ff] hover:bg-white/10 rounded-lg transition-all" target="_blank" rel="noopener noreferrer">
